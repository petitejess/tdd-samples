require_relative '../found-in-array'
...
describe "is name in the array" do
    ...
    it 'should return found in the array if name is in the array' do
        expect(found_in_array(["grant", "jessica", "mike"], "jessica")).to eq("Found in array")
    end

    it 'should return not found in the array if name is not in the array' do
